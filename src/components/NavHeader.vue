    ...
    <header class="header">
      ...
      <div class="navbar">
        <div class="navbar-left-container">
          <a href="/">
            <!-- <img class="navbar-brand-logo" src="/static/ok-2.png"> -->
          </a>
        </div>
        <div class="navbar-right-container" style="display: flex;">
          <div class="navbar-menu-container">
            ...
            <a href="javascript:void(0)" class="navbar-link" v-if="!nickName" @click="loginShow=true">Login</a>
      ...
      <div class="md-modal modal-msg md-modal-transition" :class="{'md-show': loginShow}">
        <div class="md-modal-inner">
          <div class="md-top">
            ...
            <button class="md-close" @click="loginShow=false">Close</button>
          </div>
